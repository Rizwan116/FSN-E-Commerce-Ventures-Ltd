          ...
          <table className="products-table">
            ...
            <tbody>
              {products.map((prod) => (
                <tr
                  key={prod.id}
                  className={prod.stock <= 0 ? "out-of-stock" : ""}
                >
                  <td>
                    <img
                      src={prod.image}
                  ...
                  <td>
                    <input
                      ...
                      value={prod.stock || 0}
                      onChange={(e) =>
                        handleUpdateStock(prod.id, e.target.value)
                      }
                      className="stock-input"
                    />
                  </td>
                ...
                <div key={order.id} className="order-card">
                  <div className="order-header">
                    ...
                    <div className="order-total">
                      <h5>Total: ₹{getTotalOrderValue(order)}</h5>
                      <h5>
                        <span className="payment-badge">{order.paymentMode}</span>
                      </h5>
                    </div>
                  </div>
                  <div className="customer-info">
                      ...
                      <tbody>
                        {order.cart?.items?.map((item, idx) => (
                          <tr key={idx}>
                            <td className="product-cell">
                              {item.image && (
                                <img src={item.image} alt={item.title} className="mini-product-image" />
                              )}
                              <span>{item.title}</span>
                            </td>
                            <td>₹{item.price}</td>
        ...
        <div className="users-management">
          ...
          <div className="user-cards-container">
            {users.map((user) => (
              ...
              <img src={user.profile || "https://via.placeholder.com/80"} alt="Profile" className="user-profile" />
